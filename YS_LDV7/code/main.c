     ...
     //UARTSendByte(dat);//串口识别码（十六进制）
		 ...
		 {	
			 ...
			 switch(dat)		   /*对结果执行相关操作,客户修改*/
			  {
				  case CODE_FHZJM:			/*命令“测试”*/
						PrintCom("“返回主界面”命令识别成功\r\n"); //串口输出提示信息（可删除）
						PA1=1;//让PA1端口为高电平
						Delay200ms();
						PA1 = 0	;
													 break;
					case CODE_WSDJC:	 /*命令“全开”*/
						PrintCom("“温湿度检测”命令识别成功\r\n");//串口输出提示信息（可删除）		//查看温湿度
						PA2=1;//让PA2端口为高电平
						Delay200ms();
						PA2 = 0	 ;
					...
					case CODE_BFYY:		/*命令“复位”*/				
						...
						PA5 = 0	 ;
													...
													break;
					case CODE_BFDH:		/*命令“复位”*/				
						PrintCom("“播放动画”命令识别成功\r\n"); //串口输出提示信息（可删除）
						PA6=1;//让PA6端口为高电平
						Delay200ms();
						PA6 = 0	  ;
