...
{
    {IRQ_EINT0, S3C2410_GPF0, KEY_C,        "S2"},
    {IRQ_EINT2, S3C2410_GPF2, KEY_LEFTCTRL, "S3"},
    {IRQ_EINT11,S3C2410_GPG3, KEY_ENTER,    "S4"},
    {IRQ_EINT19,S3C2410_GPG11,KEY_D,		"S5"},
};
...
//	set_bit(EV_SYN,buttons_dev->evbit);
    ...
    /* 开发板有四个按键这里规定为 C  D  ENTER、LEFTCTRL左边的ctrl */
    set_bit(KEY_C,buttons_dev->keybit);
    set_bit(KEY_D,buttons_dev->keybit);
    set_bit(KEY_ENTER,buttons_dev->keybit);
    set_bit(KEY_LEFTCTRL,buttons_dev->keybit);
